...
function setup() {
	...
	ground=Bodies.rectangle(200,height,1000,height/10, static);
	...
	//head
	p1=Bodies.circle(position.x,position.y,20,circleoptions);
...
function draw() {
  ...
  fill(255);
  noStroke();
  rect(ground.position.x,ground.position.y,2000,height/10);
  ...
  strokeWeight(10);
  //rotate(p1.angle);
  ellipse(position.x+100,position.y-160,col/1.5,col/1.5);
  //console.log(ellipse);
  pop();
  ...
  stroke(255);
  strokeWeight(4);
  line(position.x+100,position.y-160,p2.position.x,p2.position.y);
  pop();
